...
!image[image alt2](https://github.com/mr-unknown-oo7/U-net/blob/main/plot-unet.png?raw=true)

Further the trained model was tested no 2 random data achiveing the following results 

data 1:
!image[img alt3](https://github.com/mr-unknown-oo7/U-net/blob/main/u%20net%20img%202.png?raw=true)

data 2:
!image[img alt4](https://github.com/mr-unknown-oo7/U-net/blob/main/unet%20img%201.png?raw=true)
